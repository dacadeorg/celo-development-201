...
In this learning module you will learn fundamental knowledge about NFTs and how to write and deploy your own NFT contract.

In this section of the learning module, we will give you a theoretical introduction to blockchain-based tokens.
...
Since Celo is a EVM compatible layer 1 scaling solution, that allows writing contracts in Solidity, we can make use of Ethereum's token standards, contracts and much of it's tooling.
...
### 2. Connect Metmask to Alfajores

1. Click on "Ethereum Mainnet" in your MetaMask extension, then click on "Add Network".
2. Enter the data provided on this [Celo documentation](https://docs.celo.org/getting-started/wallets/using-metamask-with-celo/manual-setup). Make sure to choose the data for the Alfajores Testnet.

This GIF demonstrates how to connect to the testnet:
![](https://raw.githubusercontent.com/dacadeorg/celo-development-201/main/content/gifs/connect_metamask_alfajores)

### 3. Get Alfajores Testnet Tokens

1. Go to the Alfajores testnet faucet [https://celo.org/developers/faucet](https://celo.org/developers/faucet).
2. Enter your wallet address, cofirm the captcha, and click on "Done".
...
### 4. Deploy Contract to Alfajores

1. Compile your contract in Remix.
2. Go to the deploy tab, change the "ENVIORMENT" to "Injected Web3" and confirm.
3. Select the right contract, click on "Deploy" and confirm the transaction.
